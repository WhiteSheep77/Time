...
func HowLongAgoMaxMonth(timebefore int64, timenow int64) (strres string) {
	var TimeUint = [6]int64{365 * 86400, 30 * 86400, 86400, 3600, 60, 1}
	var StrUnit = [6]string{"年前", "月前", "天前", "小時前", "分鐘前", "秒鐘前"}
	strres = "剛剛"
...
func HowLongAgoJp(timebefore int64, timenow int64) (strres string) {
	var TimeUint = [6]int64{365 * 86400, 30 * 86400, 86400, 3600, 60, 1}
	var StrUnit = [6]string{"年前", "ヶ月前", "日前", "時間前", "分前", "秒前"}
	strres = "たった今"
